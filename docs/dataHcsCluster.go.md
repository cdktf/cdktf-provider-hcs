...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v8/datahcscluster"
...
| <code><a href="#@cdktf/provider-hcs.dataHcsCluster.DataHcsCluster.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
&datahcscluster.DataHcsClusterConfig {
	...
	ClusterName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v8.dataHcsCluster.DataHcsClusterTimeouts,
}
```
