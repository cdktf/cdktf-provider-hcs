...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v5/datahcscluster"
...
&datahcscluster.DataHcsClusterConfig {
	...
	ClusterName: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v5.dataHcsCluster.DataHcsClusterTimeouts,
}
```
