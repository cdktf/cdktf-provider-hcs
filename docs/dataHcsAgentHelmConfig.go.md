...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v6/datahcsagenthelmconfig"
...
&datahcsagenthelmconfig.DataHcsAgentHelmConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v6.dataHcsAgentHelmConfig.DataHcsAgentHelmConfigTimeouts,
}
```
