...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v5/datahcsagenthelmconfig"
...
&datahcsagenthelmconfig.DataHcsAgentHelmConfigConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v5.dataHcsAgentHelmConfig.DataHcsAgentHelmConfigTimeouts,
}
```
