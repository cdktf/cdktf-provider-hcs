...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v7/clusterroottoken"
...
&clusterroottoken.ClusterRootTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v7.clusterRootToken.ClusterRootTokenTimeouts,
}
```
