...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v8/clusterroottoken"
...
&clusterroottoken.ClusterRootTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v8.clusterRootToken.ClusterRootTokenTimeouts,
}
```
