...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v6/clusterroottoken"
...
&clusterroottoken.ClusterRootTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v6.clusterRootToken.ClusterRootTokenTimeouts,
}
```
