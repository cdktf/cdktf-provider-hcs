...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v5/clusterroottoken"
...
&clusterroottoken.ClusterRootTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v5.clusterRootToken.ClusterRootTokenTimeouts,
}
```
