...
| <code><a href="#@cdktf/provider-hcs.cluster.Cluster.hasResourceMove">hasResourceMove</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-hcs.cluster.Cluster.moveFromId">moveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
...
| <code><a href="#@cdktf/provider-hcs.cluster.Cluster.moveToId">moveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `hasResourceMove` <a name="hasResourceMove" id="@cdktf/provider-hcs.cluster.Cluster.hasResourceMove"></a>
...
##### `moveFromId` <a name="moveFromId" id="@cdktf/provider-hcs.cluster.Cluster.moveFromId"></a>
...
##### `moveToId` <a name="moveToId" id="@cdktf/provider-hcs.cluster.Cluster.moveToId"></a>
...
| <code><a href="#@cdktf/provider-hcs.cluster.Cluster.property.timeoutsInput">timeoutsInput</a></code> | <code>cdktf.IResolvable \| <a href="#@cdktf/provider-hcs.cluster.ClusterTimeouts">ClusterTimeouts</a></code> | *No description.* |
...
- *Type:* cdktf.IResolvable | <a href="#@cdktf/provider-hcs.cluster.ClusterTimeouts">ClusterTimeouts</a>
...
| <code><a href="#@cdktf/provider-hcs.cluster.ClusterTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktf.IResolvable \| <a href="#@cdktf/provider-hcs.cluster.ClusterTimeouts">ClusterTimeouts</a></code> | *No description.* |
