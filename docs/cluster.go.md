...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v4/cluster"
...
| <code><a href="#@cdktf/provider-hcs.cluster.Cluster.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&cluster.ClusterConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v4.cluster.ClusterTimeouts,
	VnetCidr: *string,
}
```
...
| <code><a href="#@cdktf/provider-hcs.cluster.ClusterConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
