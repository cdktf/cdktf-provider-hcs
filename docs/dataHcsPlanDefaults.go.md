...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v4/datahcsplandefaults"
...
| <code><a href="#@cdktf/provider-hcs.dataHcsPlanDefaults.DataHcsPlanDefaults.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&datahcsplandefaults.DataHcsPlanDefaultsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v4.dataHcsPlanDefaults.DataHcsPlanDefaultsTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-hcs.dataHcsPlanDefaults.DataHcsPlanDefaultsConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
