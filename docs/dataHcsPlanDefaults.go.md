...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v5/datahcsplandefaults"
...
&datahcsplandefaults.DataHcsPlanDefaultsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v5.dataHcsPlanDefaults.DataHcsPlanDefaultsTimeouts,
}
```
