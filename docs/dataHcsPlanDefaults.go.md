...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v6/datahcsplandefaults"
...
&datahcsplandefaults.DataHcsPlanDefaultsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v6.dataHcsPlanDefaults.DataHcsPlanDefaultsTimeouts,
}
```
