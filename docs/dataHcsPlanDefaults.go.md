...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v3/datahcsplandefaults"
...
&datahcsplandefaults.DataHcsPlanDefaultsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v3.dataHcsPlanDefaults.DataHcsPlanDefaultsTimeouts,
}
```
