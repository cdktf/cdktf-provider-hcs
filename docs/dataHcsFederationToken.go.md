...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v5/datahcsfederationtoken"
...
&datahcsfederationtoken.DataHcsFederationTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v5.dataHcsFederationToken.DataHcsFederationTokenTimeouts,
}
```
