...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v6/datahcsfederationtoken"
...
&datahcsfederationtoken.DataHcsFederationTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v6.dataHcsFederationToken.DataHcsFederationTokenTimeouts,
}
```
