...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v3/datahcsfederationtoken"
...
| <code><a href="#@cdktf/provider-hcs.dataHcsFederationToken.DataHcsFederationToken.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&datahcsfederationtoken.DataHcsFederationTokenConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v3.dataHcsFederationToken.DataHcsFederationTokenTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-hcs.dataHcsFederationToken.DataHcsFederationTokenConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
