...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v8/datahcsagentkubernetessecret"
...
&datahcsagentkubernetessecret.DataHcsAgentKubernetesSecretConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v8.dataHcsAgentKubernetesSecret.DataHcsAgentKubernetesSecretTimeouts,
}
```
