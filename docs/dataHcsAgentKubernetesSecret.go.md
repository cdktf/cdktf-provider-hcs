...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v5/datahcsagentkubernetessecret"
...
&datahcsagentkubernetessecret.DataHcsAgentKubernetesSecretConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v5.dataHcsAgentKubernetesSecret.DataHcsAgentKubernetesSecretTimeouts,
}
```
