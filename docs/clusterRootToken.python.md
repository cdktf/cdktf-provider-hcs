...
| <code><a href="#@cdktf/provider-hcs.clusterRootToken.ClusterRootToken.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-hcs.clusterRootToken.ClusterRootToken.toHclTerraform"></a>
