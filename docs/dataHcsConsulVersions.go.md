...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v5/datahcsconsulversions"
...
&datahcsconsulversions.DataHcsConsulVersionsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v5.dataHcsConsulVersions.DataHcsConsulVersionsTimeouts,
}
```
