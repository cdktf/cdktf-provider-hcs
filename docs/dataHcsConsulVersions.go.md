...
```go
import "github.com/cdktf/cdktf-provider-hcs-go/hcs/v8/datahcsconsulversions"
...
&datahcsconsulversions.DataHcsConsulVersionsConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-hcs-go/hcs/v8.dataHcsConsulVersions.DataHcsConsulVersionsTimeouts,
}
```
